...
/**
 * Handles the actions required for starting an agent.
 *
 * @author Dr Christos Bohoris
 */
public class StartAgentListener implements ActionListener {
    ...
    private static final Logger LOGGER = LogManager.getLogger(StartAgentListener.class.toString());
    
    StartAgentListener(JTable agentTable, AgentTableModel agentTableModel, Station agentStation, LogTableModel logTableModel) {

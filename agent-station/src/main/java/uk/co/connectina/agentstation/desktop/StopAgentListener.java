...
/**
 * Handles the actions required for stoping an agent.
 *
 * @author Dr Christos Bohoris
 */
public class StopAgentListener implements ActionListener {
    ...
    private static final Logger LOGGER = LogManager.getLogger(StopAgentListener.class.toString());

    StopAgentListener(JTable agentTable, AgentTableModel agentTableModel, Station agentStation, LogTableModel logTableModel) {
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        try {
            agentStation.stopAgent(instance);
